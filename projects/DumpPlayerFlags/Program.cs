...
namespace DumpPlayerFlags
{
    internal class Program
    {
        ...
        {
            var ozPlayerFlagDefinitionClass = engine.GetClass("WillowGame.OzPlayerFlagDefinition");
            if (ozPlayerFlagDefinitionClass == null)
            {
            ...
            using (var writer = new JsonTextWriter(output))
            {
                ...
                {
                    writer.WritePropertyName(ozPlayerFlagDefinition.GetPath());
                    writer.WriteValue((int)ozPlayerFlagDefinition.HashValue);
                }
